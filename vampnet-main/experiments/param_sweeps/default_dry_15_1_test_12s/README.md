# VampNet Default-Model Parameter Sweep
...
The folder also contains one baseline run using the base/default parameter
vector. The random seed is fixed at `20260617` for comparable outputs.
